    ...
    <AppShell title="Work Orders">
      <div className="space-y-6">
        <section className="fop-card p-6">
          ...
          <h2 className="mt-2 text-xl font-semibold text-[#0F172A]">Field Work Requiring Action</h2>
        ...
        <DataTable
          rows={workOrders}
          columns={[
            { key: "building", header: "Building", render: (row) => <span className="font-semibold text-[#0F172A]">{row.building}</span> },
