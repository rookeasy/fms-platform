    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-[#B6C1CF]">{building.city}</p>
          <div className="mt-3 flex flex-wrap gap-2 text-xs font-semibold uppercase tracking-[0.14em] text-[#7D8CA3]">
      ...
      <div className="mt-5 flex flex-wrap items-center gap-3">
        ...
        <span className="text-sm text-[#B6C1CF]">{building.passportStatus}</span>
      </div>
      <div className="mt-5">
