    ...
    >
      ...
      <div className="relative py-4">
        <div className={`relative ${styles.track} overflow-hidden rounded-full bg-[#CBD5E1]`}>
          <div
            className={`${styles.track} rounded-full bg-[color:var(--fuzion-build)] transition-[width] duration-700 ease-out`}
        ...
        <div
          ...
          style={{ left: `${displayScore}%`, borderColor: "var(--fuzion-build)" }}
        >
